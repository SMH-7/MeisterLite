...
class TFeditorVC: UIViewController {
    ...
    lazy private var containerView = TFeditorContainer()
    lazy private var editableTF = TFeditorTextField()
...
extension TFeditorVC : UITextFieldDelegate {
